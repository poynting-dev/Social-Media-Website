...
<html>
<body leftmargin="50">
    <title>Social_Book $userstr</title>
  </head>
  <body>
    <div data-role='page'>
      <div data-role='header'>
        <div id='logo' class='center'>Social_Book</div>
        <div id='' class='center'>
        </div>
...
echo <<<_LOGGEDIN
        <div class='center'>
          ...
          <a data-role='button' data-inline='true' data-icon='mail'
            data-transition="slide" href='http://127.0.0.1:3000/'>Room</a>
